...
tr.fixed { background-color: green; }
	...
	<body>
		<p>Generated by <a href="https://github.com/OpenMandrivaSoftware/Mass_build_fail_scripts/blob/master/generate-status.sh">generate-status.sh</a> -- please add more detection of common errors there.</p>
EOF
